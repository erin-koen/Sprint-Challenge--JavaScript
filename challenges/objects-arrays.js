...
let newString = '';
for (let i = 0; i< graduates.length; i++){
  newString = `${graduates[i]['first_name']} ${graduates[i]['email']}`
  contactInfo.push(newString);
}
...
// zooAnimals.map((data)=> {
//   return {'Name': data.animal_name, 'Scientific': data.scientific_name};
// });
...
// erin's note - feel like that array should be called lowerPopulation?
